...
exports.updateDoctor = async (req, res) => {
  try {
    ...
    res.status(400).json({
      status: "Fail",
      message: err.message || "Error updating doctor",
    });
  }
};
...
exports.getAllDoctors = async (req, res) => {
  try {
    ...
    res.status(500).json({
      status: "Fail",
      message: err.message || "Error fetching doctors",
    });
  }
};
...
exports.getDoctorById = async (req, res) => {
  try {
    ...
    res.status(404).json({
      status: "Fail",
      message: err.message || "Doctor not found",
    });
  }
};
...
exports.deleteDoctor = async (req, res) => {
  try {
    ...
    res.status(400).json({
      status: "Fail",
      message: err.message || "Error deleting doctor",
    });
  }
};
